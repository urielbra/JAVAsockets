  ...
  public static void main(String args[]) throws Exception
    {
      ...
      DatagramSocket serverSocketAux = new DatagramSocket(8080); //Cria uma porta no 8080

      serverSocketAux.connect(InetAddress.getByName("8.8.8.8"), 10002);
      String ip = serverSocketAux.getLocalAddress().getHostAddress();
